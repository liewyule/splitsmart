...
export default function BottomNav({ code }: { code: string }) {
  ...
  return (
    <nav className="bottom-nav">
      <div className="mx-auto flex max-w-[420px] items-center justify-between px-4 py-1">
        {items.map((item) => {
          ...
          return (
            <Link
              ...
              href={href}
              prefetch
              className={`flex flex-col items-center gap-1 rounded-xl px-4 py-2.5 text-xs font-medium transition pressable ${
